...
const update = async (req: Request<Param>, res: Response, next: NextFunction): Promise<any> => {
...
const remove = async (req: Request<Param>, res: Response, next: NextFunction): Promise<any> => {
  const id = req.params.id;
